...
class VhdlHeader(Generator, Jinja2):
    """Create VHDL header file with register map defines.
    ...
    def __init__(self, rmap=None, path='regs_pkg.vhd', prefix="CSR", **args):
        super().__init__(rmap, **args)
        self.path = path
        self.prefix = prefix
